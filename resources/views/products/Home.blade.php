...
@section('content')
    <div class="text-center">
        <h1 class="text-4xl my-2">Trade Categories</h1>
        <div class="flex justify-start  my-4 text-center w-full">
            <div class="w-80 h-1 bg-gray-500 right-0"></div>
        </div>
    </div>
    <div class="gallery_body" id="desktop_view">
        ...
        <div class="gallery-container item-1 wd-3 ht-4 overflow-hidden">
            <div class="gallery-item">
                ...
                {{-- title --}}
                <div class="bg-white  border-orange-500 p-4 absolute left-0 top-0">
                    <p class="text-3xl">Furniture</p>
                </div>
                {{-- description --}}
                <div class="dec flex justify-center flex-col text-2xl bg-slate-700 font-bold text-white p-2">
                    <P class="p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis reiciendis in commodi
        ...
        <div class="gallery-container ht-1 wd-3 relative">
            <div class="">
                ...
                <div class="bg-white  border-orange-500 p-4  left-0 top-0">
